...
export default function PreloaderCinematic({ onDone }) {
 ...
 animate={reduced ? { y: 0, opacity: 1 } : { y: [120, -8, 0], opacity: [0, 1, 1] }}
 transition={reduced ? { duration: 0 } : { duration: 1.1, times: [0.04, 0.52, 1], ease: "easeInOut" }}
 >
 <img src="/ojix-primary-transparent-ondark.svg" alt="OJIX" className="pre-logo-img" />
 </motion.div>
 </div>
